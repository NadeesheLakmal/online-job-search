...
<div id="content">
	<div class="post">
		...
		<p><font size=4></font></p></h1><p>Select job location, to start your search.</p>
		<p>Job Location:<select name="location" value=""><option value="Delhi">Delhi</option><option value="Mumbai">Mumbai</option><option value="Kolkata">Kolkata</option><option value="Chennai">Chennai</option></select></p>
		
		<p><center><input type="submit" value="Start Search"></center></form></p>
		<p><font size=3><a href="seek_profile.jsp">Quick Job Search</a>|<a href="advance.html">Advanced Job Search<a>|<a href="job_cat.jsp">Jobs by Category</a>|</font></p>
	</div>
<div class="post">
